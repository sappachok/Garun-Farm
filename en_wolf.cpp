...
void CWolf::Load()
{
	if(bSpeciel==TRUE)
	{
		CMD2Model::Load("Data\\Model\\darkwolf\\darkwolf.md2","Data\\Model\\darkwolf\\wolftext.tga",0.35f);
		sound->LoadFromFile( sound3D_Monster_shoot.lpdsBuffer,
			sound3D_Monster_shoot.lpds3DBuffer,"Data\\Sound\\Blow2.wav");
	}
	else
	{
		CMD2Model::Load("Data\\Model\\darkwolf\\darkwolf.md2","Data\\Model\\darkwolf\\wolftext.tga",0.15f);
		sound->LoadFromFile( sound3D_Monster_shoot.lpdsBuffer,
			sound3D_Monster_shoot.lpds3DBuffer,"Data\\Sound\\Blow2.wav");
	}
...
void CWolf::OnDraw(CCamera *camera)
{
	CMD2Model::Move(position.x,0,position.z);	
	CMD2Model::Render();
}

void CWolf::OnCollision(CObject *collisionObject) 
{ 	
...
void CWolf::OnAnimate(float deltaTime)
{
...
void CWolf::OnCollisionBox(CObject *collisionObject)
{

#ifndef EN_BOSS02_CPP
#define EN_BOSS02_CPP
#endif
...
void CBoss02::Load()
{
	CMD2Model::Load("Data\\Model\\goblin\\tris.md2","Data\\Model\\goblin\\boss02.tga",0.1f);
...
void CBoss02::OnDraw(CCamera *camera)
{
...
void CBoss02::OnCollision(CObject *collisionObject) 
{ 	
...
void CBoss02::ProcessAI()
{
		...
		(target->type == MD_FRIEND) && (aiState != AI_ANGRY))
	{
		...
		if(distFromTarget < size + target->size + 2)
		{
			aiState = AI_ATTACK;
		}
		else
...
void CBoss02::OnAnimate(float deltaTime)
{
	deltaTime = deltaTime * 1.3f;
...
void CBoss02::OnCollisionBox(CObject *collisionObject)
{

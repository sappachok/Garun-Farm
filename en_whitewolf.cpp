#ifndef _WHITEWOLF_CPP
#define _WHITEWOLF_CPP
#endif
...
void CWhiteWolf::Load()
{
	if(bSpeciel == TRUE)
	{
		CMD2Model::Load("Data\\Model\\darkwolf\\darkwolf.md2","Data\\Model\\darkwolf\\whitewolf.tga",0.25f);
		sound->LoadFromFile( sound3D_Monster_shoot.lpdsBuffer,
			sound3D_Monster_shoot.lpds3DBuffer,"Data\\Sound\\Blow2.wav");
	}
	else
	{
		CMD2Model::Load("Data\\Model\\darkwolf\\darkwolf.md2","Data\\Model\\darkwolf\\whitewolf.tga",0.15f);
		sound->LoadFromFile( sound3D_Monster_shoot.lpdsBuffer,
			sound3D_Monster_shoot.lpds3DBuffer,"Data\\Sound\\Blow2.wav");
	}
}

void CWhiteWolf::OnDraw(CCamera *camera)
{
	CMD2Model::Move(position.x,position.y,position.z);	
	CMD2Model::Render();
}

void CWhiteWolf::OnCollision(CObject *collisionObject) 
{ 	
...
void CWhiteWolf::OnAnimate(float deltaTime)
{
...
void CWhiteWolf::OnCollisionBox(CObject *collisionObject)
{

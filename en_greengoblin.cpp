#ifndef EN_GREENGOBLIN_CPP
#define EN_GREENGOBLIN_CPP
#endif
...
void CGoblin::Load()
{
	if(bSpeciel==TRUE)
	{
		CMD2Model::Load("Data\\Model\\goblin\\tris.md2","Data\\Model\\goblin\\cathos.tga",0.1f);
...
void CGoblin::OnDraw(CCamera *camera)
{
...
void CGoblin::OnCollision(CObject *collisionObject) 
{ 	
...
void CGoblin::OnAnimate(float deltaTime)
{
...
void CGoblin::OnCollisionBox(CObject *collisionObject)
{

#ifndef EN_BOSS04_CPP
#define EN_BOSS04_CPP
#endif
...
void CBoss04::Load()
{
	CMD2Model::Load("Data\\Model\\goblin\\tris.md2","Data\\Model\\goblin\\boss04.tga",0.1f);
...
void CBoss04::OnDraw(CCamera *camera)
{
...
void CBoss04::OnCollision(CObject *collisionObject) 
{ 	
...
void CBoss04::OnAnimate(float deltaTime)
{
	deltaTime = deltaTime * 1.8f;
...
void CBoss04::UpdateEnemy()
{
	...
	if(aiState == AI_ATTACK)
	{
		...
		{
			dirToTarget = GetDirToObject(victim[0]);
		}
	}
	else
	{
...
void CBoss04::OnCollisionBox(CObject *collisionObject)
{

#ifndef EN_WORRIORGOBLIN_CPP
#define EN_WORRIORGOBLIN_CPP
#endif

#include "en_worriorgoblin.h"

void CWorriorGoblin::Load()
{
	if(bSpeciel==TRUE)
	{
		CMD2Model::Load("Data\\Model\\goblin\\tris.md2","Data\\Model\\goblin\\warrior.tga",0.2f);
		weapon.Load("Data\\Model\\goblin\\weapon.md2","Data\\Model\\goblin\\weapon.tga",0.2f);
	}
	else
	{
		CMD2Model::Load("Data\\Model\\goblin\\tris.md2","Data\\Model\\goblin\\warrior.tga",0.15f);
...
void CWorriorGoblin::OnDraw(CCamera *camera)
{
...
void CWorriorGoblin::OnCollision(CObject *collisionObject) 
{ 	
...
void CWorriorGoblin::OnAnimate(float deltaTime)
{
...
void CWorriorGoblin::UpdateEnemy()
{
...
void CWorriorGoblin::OnCollisionBox(CObject *collisionObject)
{
